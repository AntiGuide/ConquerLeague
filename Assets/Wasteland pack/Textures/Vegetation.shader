    ...
    SubShader {
        ...
        Pass {
                ...
                out half4 outEmission : SV_Target3 )
            {
                ...
                clip(saturate(( _Alpha > 0.5 ? (1.0-(1.0-2.0*(_Alpha-0.5))*(1.0-_Diffuse_var.a)) : (2.0*_Alpha*_Diffuse_var.a) )) - 0.5);
////// Lighting:
